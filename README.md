...
A compact, working example of an industrial-IoT time-series pipeline built on GridDB using its native Java client. It models a turbine sensor, ingests a stream of timestamped readings with inline anomaly tagging, and runs the range, aggregation, and TQL queries an industrial monitoring system actually needs.
...
Java 11+
A running GridDB cluster (default: cluster myCluster on 127.0.0.1:10001) — see the GridDB quickstart
...
bashjavac -cp gridstore.jar SensorPipeline.java
